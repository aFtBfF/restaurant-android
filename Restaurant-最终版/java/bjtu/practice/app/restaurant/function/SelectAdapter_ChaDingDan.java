...
public class SelectAdapter_ChaDingDan extends RecyclerView.Adapter<SelectAdapter_ChaDingDan.ViewHolder>{
    private ChoseOrderActivity activity;
    private SparseArray<OrdersItem> dataList;
    private NumberFormat nf;
    private LayoutInflater mInflater;
    public SelectAdapter_ChaDingDan(ChoseOrderActivity activity, SparseArray<OrdersItem> dataList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        OrdersItem item = dataList.valueAt(position);
