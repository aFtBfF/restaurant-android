...
//    private TypeAdapter typeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        TextView tv_myOrder = (TextView)findViewById(R.id.tv_myOrder);
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.tv_myOrder:
                ArrayList<OrdersItem> ordersList = null;
                ordersList = OrdersItem.getGoodsList(userName);
                if(ordersList.size() == 0){
                    Toast.makeText(this, "还没有订单哦！" , Toast.LENGTH_SHORT).show();
                }
                else{
                    Intent intent = new Intent(ChoseCanteenActivity.this , ChoseOrderActivity.class);
