...
import bjtu.practice.app.restaurant.function.GoodsAdapter;
import bjtu.practice.app.restaurant.function.SelectAdapter;
import bjtu.practice.app.restaurant.function.TypeAdapter;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList = GoodsItem.getGoodsList(restaurantId);
        typeList = GoodsItem.getTypeList(restaurantId);
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.clear:
                ...
                break;
            case R.id.tvSubmit:
                //Toast.makeText(ShoppingCartActivity.this, "订单已提交", Toast.LENGTH_SHORT).show();
                submitOrder();
                break;
            default:
                break;
    ...
    private void submitOrder() {
        ...
        for(int i = 0 ; i < selectedList.size() ; i++){
            item = selectedList.valueAt(i);
            object = new JSONObject();
            try {
                object.put("window",item.typeId);
                object.put("dish",item.id);
                object.put("number",item.count);
        ...
        object = new JSONObject();
        try {
            object.put("menu",array);
            object.put("restaurant",restaurantId);
            object.put("price",cost);
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.sss");
            Date curDate = new Date(System.currentTimeMillis());//获取当前时间
            String time = formatter.format(curDate);
            object.put("taketime", time);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        builder.add("order",object.toString());
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                Toast.makeText(ShoppingCartActivity.this, "订单已提交", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ShoppingCartActivity.this , ChoseOrderActivity.class);
